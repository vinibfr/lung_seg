...
def main():
    ...
    meta = pd.read_csv('../preprocessing/data/meta.csv')                    
    ############################################################################
    ...
    OUTPUT_MASK_DIR = './preprocessing/data/Segmentation_output/{}'.format(NAME)
    ...
    ## Load Clean related ####
    ##########################
    CLEAN_DIR_IMG ='../preprocessing/data/Clean/Image/'
    CLEAN_DIR_MASK ='../preprocessing/data/Clean/Mask/'
    clean_meta = pd.read_csv('../preprocessing/data/clean_meta.csv')
    ...
    CLEAN_OUTPUT_MASK_DIR = 'E:\preprocessing_lidc\data\Segmentation_output/{}'.format(CLEAN_NAME)
